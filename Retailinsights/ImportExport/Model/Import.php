...
class Import extends \Magento\ImportExport\Model\Import {
    ...
    const CREATE_ATTRIBUTES_CONF_PATH = 'Retailinsights_importexport/general/create_attributes';

    /**
     * @var \Retailinsights\ImportExport\Model\Source\ConfigInterface
     */
    protected $_config;

    /**
     * @var \Retailinsights\ImportExport\Helper\Data
     */
    protected $_helper;
    ...
    /**
     * @var \Retailinsights\ImportExport\Model\Source\Type\AbstractType
     */
    protected $_source;
    ...
    /**
     * @param \Retailinsights\ImportExport\Model\Source\ConfigInterface        $config
     * @param \Retailinsights\ImportExport\Helper\Data                         $helper
    ...
    public function __construct(
        \Retailinsights\ImportExport\Model\Source\ConfigInterface $config,
        \Retailinsights\ImportExport\Helper\Data $helper,
        ...
        $this->_debugMode = (bool) $this->_coreConfig->getValue(
            'Retailinsights_importexport/general/debug',
