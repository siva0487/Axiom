...
namespace Retailinsights\ImportExport\Model\Import;
...
use Retailinsights\ImportExport\Logger\Logger;
...
class Product extends MagentoProduct
{
            ...
            foreach ($nextBunch as $rowNum => $rowData) {
                ...
                if (!isset($this->_oldSku[strtolower($rowSku)])) {
                    ...
                    $entityRowsUp[] = [
                        ...
                        'attribute_set_id' => $this->skuProcessor->getNewSku(strtolower($rowSku))['attr_set_id']
                    ];
                }
                ...
                $createValuesAllowed = (bool) $this->scopeConfig->getValue(
                    \Retailinsights\ImportExport\Model\Import::CREATE_ATTRIBUTES_CONF_PATH,
     ...
     *
     * @see \Retailinsights\ImportExport\Block\Adminhtml\Job\Edit\Tab\Map
     */
