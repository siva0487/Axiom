<?php
/**
 * @copyright: Copyright © 2017 Retailinsights Studio GmbH. All rights reserved.
 * @author: Retailinsights Studio <fbeardev@gmail.com>
 */

namespace Retailinsights\ImportExport\Plugin\Controller\Adminhtml\Import;

use Magento\Framework\App\Action\Context;
use Magento\Framework\Controller\ResultFactory;
use Retailinsights\ImportExport\Model\Import;
...
class Validate
{
    ...
    /**
     * @var \Retailinsights\ImportExport\Model\Import
     */
        ...
        if ($data) {
            ...
            try {
                ...
                if (stripos($sourcePath, '.txt')) {
                    $source = new \Retailinsights\ImportExport\Model\Import\Source\Txt(
                        $sourcePath,
                        $directory,
